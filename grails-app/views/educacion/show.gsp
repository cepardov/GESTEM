...
<html>
    ...
    <body>
        ...
        <div id="show-educacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="educacion" />
            <g:form resource="${this.educacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.educacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
