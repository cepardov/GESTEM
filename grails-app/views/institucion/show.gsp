...
<html>
    ...
    <body>
        ...
        <div id="show-institucion" class="content scaffold-show" role="main">
            ...
            <f:display bean="institucion" />
            <g:form resource="${this.institucion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.institucion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
