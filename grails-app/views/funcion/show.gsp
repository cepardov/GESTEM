...
<html>
    ...
    <body>
        ...
        <div id="show-funcion" class="content scaffold-show" role="main">
            ...
            <f:display bean="funcion" />
            <g:form resource="${this.funcion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.funcion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
