        ...
        <table class="responsive-table bordered highlight-2 centered">
            ...
            <g:each var="v" in="${telefonoList}">
                <tr>
                    <td>${v.phoneNumber}</td>
                    <td>
                        <g:link class="btn-floating waves-effect waves-light yellow darken-2 tooltipped" controller="telefono" action="index" id="${v.id}" params="[r : 'showUsuario',idUsuario : this.usuario.id, name : params.name, lastName : params.lastName]" data-position="left" data-delay="50" data-tooltip="Editar Teléfono"><i class="material-icons">edit</i></g:link>
            ...
            <tr>
                <td></td>
                <td>
                    <g:link class="btn-floating waves-effect waves-light green tooltipped" controller="telefono" action="index" id="" params="[r : 'showUsuario',idUsuario : this.usuario.id, name : params.name, lastName : params.lastName]" data-position="left" data-delay="50" data-tooltip="Agregar Teléfono"><i class="material-icons">add</i></g:link>
                </td>
            </tr>
            </tbody>
        </table>
