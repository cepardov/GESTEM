...
<html>
    ...
    <body>
        ...
        <div id="show-comuna" class="content scaffold-show" role="main">
            ...
            <f:display bean="comuna" />
            <g:form resource="${this.comuna}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.comuna}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
