...
<html>
    ...
    <body>
        ...
        <div id="show-correo" class="content scaffold-show" role="main">
            ...
            <f:display bean="correo" />
            <g:form resource="${this.correo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.correo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
