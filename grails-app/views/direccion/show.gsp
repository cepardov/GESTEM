...
<html>
    ...
    <body>
        ...
        <div id="show-direccion" class="content scaffold-show" role="main">
            ...
            <f:display bean="direccion" />
            <g:form resource="${this.direccion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.direccion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
