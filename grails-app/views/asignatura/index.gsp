        ...
        <div class="row">
            <table class="responsive-table bordered highlight-2 centered">
                ...
                <g:each var="v" in="${asignaturaList}">
                    <tr onclick="location='<g:createLink controller="ciudad" action="index" params="[paisId: params.paisId, asignaturaId : v.id, asignaturaName : v.name]"/>'">
...
<div id="modalEdicion" class="modal bottom-sheet">
    <div class="modal-content">
        ...
        <div class="row">
        <!---rut, nombre, paterno, clave, materno, valor, estado, asignatura, valorHoraExtra--->
