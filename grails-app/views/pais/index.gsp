    ...
    <div class="col s12">
        <table class="responsive-table bordered highlight centered">
            ...
            <g:each var="v" in="${paisList}">
                <tr onclick="location = '<g:createLink controller="region" action="index" params="[paisId : v.id, paisName : v.name]"/>'">
                    <td>${v.code}</td>
                    <td>${v.name}</td>
                    <td>
                        <g:link class="btn-floating waves-effect waves-light yellow darken-2 tooltipped" id="${v.id}"
                                data-position="left" data-delay="50" data-tooltip="Editar ${controllerName}"><i
                                class="material-icons">edit</i></g:link>
                        <g:link class="btn-floating waves-effect waves-light red tooltipped" action="eliminar"
                                id="${v.id}" data-position="left" data-delay="50"
                                data-tooltip="Eliminar ${controllerName}"><i class="material-icons">delete</i></g:link>
                    </td>
                </tr>
            </g:each>
            </tbody>
                ...
                <g:form action="save">
                    <div class="row">
                        <div class="input-field col s12 m2">
                            <f:input property="code" id="code" bean="pais"/>
                            <label for="code">Codigo</label>
                        </div>

                        <div class="input-field col s12 m2">
                            <f:input property="name" id="name" bean="pais"/>
                    ...
                    <div class="fixed-action-btn">
                        <button name="create"
                                ...
                                data-position="left" data-delay="50" data-tooltip="Guardar ${controllerName}"><i
            ...
            <div class="row">
                <g:form class="col s12" resource="${this.pais}" method="PUT">
                    ...
                    <div class="fixed-action-btn">
                        <button name="create"
                                class="save waves-effect waves-light btn-floating btn-large teal tooltipped"
                                value="${message(code: 'default.button.update.label', default: 'Update')}" type="submit"
                                data-position="left" data-delay="50" data-tooltip="Actualizar ${controllerName}"><i
                                class="material-icons right">send</i></button>
                        <g:link action="index"
