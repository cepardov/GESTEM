...
<html>
    ...
    <body>
        ...
        <div id="show-ciudad" class="content scaffold-show" role="main">
            ...
            <f:display bean="ciudad" />
            <g:form resource="${this.ciudad}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ciudad}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
